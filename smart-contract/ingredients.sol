...
library SafeMath {
    ...
    */
    ...
    modifier onlyAdminUser() {
        require(msg.sender === adminUserAddress, "Only admin user can able to send reward.")
    }
    ...
    // calculate Rarity 
    function sendRewardToRarestPizzaOwner( uint256 _pizzaId, uint256 rarityLowest, address pizzaCurrentOwner, string memory imageUrl) external payable onlyAdminUser{
    ...
    function updateAdminUserAddress(address addr) public onlyOwner{
        adminUserAddress = addr;
    }
}