...
import Collections from "./views/Collection/Collections.js"
...
import WhitelistedTimings from 'views/Settings/WhitelistedTimings';
...
import Pizzas from 'views/Pizza/Pizzas';
...
var routes = [
  ...
  // },
  {
    ...
    submenus: [
      ...
      {
        path: "/whitelisted-user-timing",
        layout: Admin,
        name: "Whitelisted User Timing",
        // mini: "WUT",
        icon: "nc-icon nc-time-alarm",
        access: true, exact: true,
        component: WhitelistedTimings,
        showInSideBar: true,
      },
      // {
      //   path: "/nfts-settings",
      ...
      // },
      //     // {
      //     //   path: "/timing-random-pizza-settings",
      //     //   layout: Admin,
      //     //   name: "Random Pizza Timing",
      //     //   mini: "RPT",
      //     //   access: true, exact: true,
      //     //   component: RandomPizzaTimings,
      //     //   showInSideBar: true,
      //     // }
      //     // {
