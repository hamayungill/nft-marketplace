...
module.exports = {
    ENV: {
        ...
        blockNumberExplorer: process.env.REACT_APP_BLOCKNUMBER_EXPLORER,
        ...
        categoryOptions: [
            { value: 'base', label: 'Base', type: 1 },
            { value: 'sauce', label: 'Sauce', type: 2 },
            { value: 'cheese', label: 'Cheese', type: 3 },
            { value: 'meat', label: 'Meat', type: 4 },
            { value: 'topping', label: 'Topping', type: 5 }
        ]
    }
}
