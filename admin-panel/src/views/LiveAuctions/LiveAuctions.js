                                ...
                                <Modal.Body>
                                    <Form>
                                        <Form.Group>
                                            <label>Image: </label>
                                            <div>
                                                <img src={auction.nft.image ? auction.nft.image : collectionDefaultImg} width="200" height="150" />
                                            </div>
                                        </Form.Group>

                                        <Form.Group>
                                            <label>Name: {auction.nft.name}</label>
                                        </Form.Group>
                                        ...
                                        <Form.Group>
                                            <label>Start Date: {auction.startDate}</label>
                                        </Form.Group>

                                        <Form.Group>
                                            <label>End Date: {auction.endDate}</label>
                                        </Form.Group>
