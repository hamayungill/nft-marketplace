        ...
        return (
          ...
          >
            ...
            >
              ...
              <p>
                {prop.name} <b className="dropdown-toggle"></b>
              </p>
            </Nav.Link>
            <Collapse in={state[prop.state]}>
              <div>
                <Nav as="ul" className="settings-menu">{createLinks(prop.submenus)}</Nav>
              </div>
            </Collapse>
          </Nav.Item>
        );
          ...
          <div className="logo">
            ...
            >
              <div className="logo-img">
                <img
                  src={require("assets/img/pizza.png").default}
                  alt="react-logo" className="img-fluid"
                />
              </div>
            </Link>
            <Link
              ...
              to="/dashboard"
            >
              <span className="red-text fw-bold">{ENV.appName}</span>
            </Link>
          </div>
          {/* <div className="user">
            <div className="photo">
...
let linkPropTypes = {
  ...
  // oneOfType([PropTypes.func, PropTypes.element]),
};
